...
public class DoggieAttackTest {
    ...
    public void attackCharacterExecuteTest() {
        ...
        Doggie attacker = new Doggie(dummyPosition);
        AttackStrategy doggieAttack = new DoggieAttack();
        // Test attack with no defences
        doggieAttack.execute(attacker, character, 0, 0, false, 0);
        assertEquals(character.getHealth(), 90);
        // Check campfire does not affect damage
        character.setHealth(100);
        doggieAttack.execute(attacker, character, 0, 0, true, 0);
        assertEquals(character.getHealth(), 90);
        // Test attack with fixedDefences
        character.setHealth(100);
        doggieAttack.execute(attacker, character, 0, 2, false, 0);
        assertEquals(character.getHealth(), 92);
        // Test attack with scalarDefences
        character.setHealth(100);
        doggieAttack.execute(attacker, character, 30, 0, false, 0);
        assertEquals(character.getHealth(), 93);
        // Test attack with both fixed and scalarDefences
        character.setHealth(100);
        doggieAttack.execute(attacker, character, 50, 2, false, 0);
    ...
    public void attackAllyExecuteTest() {
        ...
        AttackStrategy doggieAttack = new DoggieAttack();
        // Test attack with no defences
        doggieAttack.execute(attacker, ally, 0, 0, false, 0);
        assertEquals(ally.getHealth(), 20);
        // Check campfire does not affect damage
        ally.setHealth(50);
        doggieAttack.execute(attacker, ally, 0, 0, true, 0);
        assertEquals(ally.getHealth(), 20);
        // Test attack with defences does not affect damage
        ally.setHealth(50);
        doggieAttack.execute(attacker, ally, 20, 2, false, 0);
        assertEquals(ally.getHealth(), 20);
    }
}
